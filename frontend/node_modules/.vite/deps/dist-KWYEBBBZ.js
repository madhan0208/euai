...
var Element = class _Element {
  getAttribute(name) {
    ...
    if (!attr && createIfNotExists) {
      ...
      this.attributes.set(name, attr2);
      return attr2;
    }
  ...
  constructor(document2, node2, captureTextNodes = false) {
    ...
    this.stylesSpecificity = /* @__PURE__ */ new Map();
    ...
    Array.from(node2.attributes).forEach((attribute) => {
      ...
      this.attributes.set(nodeName, new Property(document2, nodeName, attribute.value));
    });
    ...
    if (this.getAttribute("style").hasValue()) {
      ...
      styles.forEach((style) => {
        ...
        if (name) {
          this.styles.set(name, new Property(document2, name, value));
        }
      });
    }
  ...
  createPattern(ctx, _2, parentOpacityProp) {
    ...
    for (let x = -1; x <= 1; x++) {
      for (let y2 = -1; y2 <= 1; y2++) {
        ...
        patternSvg.attributes.set("y", new Property(this.document, "y", y2 * patternCanvas.height));
...
var GradientElement = class extends Element {
  ...
  createGradient(ctx, element, parentOpacityProp) {
    ...
    if (this.getAttribute("gradientTransform").hasValue()) {
      ...
      rect.attributes.set("x", new Property(document2, "x", -MAX_VIRTUAL_PIXELS / 3));
      rect.attributes.set("y", new Property(document2, "y", -MAX_VIRTUAL_PIXELS / 3));
      rect.attributes.set("width", new Property(document2, "width", MAX_VIRTUAL_PIXELS));
      rect.attributes.set("height", new Property(document2, "height", MAX_VIRTUAL_PIXELS));
      const group = new GElement(document2);
      group.attributes.set("transform", new Property(document2, "transform", this.getAttribute("gradientTransform").getValue()));
      group.children = [
        rect
      ];
      const patternSvg = new SVGElement(document2);
      patternSvg.attributes.set("x", new Property(document2, "x", 0));
      patternSvg.attributes.set("y", new Property(document2, "y", 0));
      patternSvg.attributes.set("width", new Property(document2, "width", rootView.width));
      patternSvg.attributes.set("height", new Property(document2, "height", rootView.height));
      patternSvg.children = [
        group
      ];
...
var FontElement = class extends Element {
  ...
  constructor(document2, node2, captureTextNodes) {
    ...
    this.arabicGlyphs = /* @__PURE__ */ new Map();
    this.isRTL = false;
    this.horizAdvX = this.getAttribute("horiz-adv-x").getNumber();
    const { definitions } = document2;
    const { children } = this;
  ...
  async load(fontFamily, url) {
    try {
      ...
      Array.from(fonts).forEach((fontNode) => {
        ...
        document2.definitions.set(fontFamily, font);
      });
    } catch (err) {
  ...
  constructor(document2, node2, captureTextNodes) {
    ...
    cssDefs.forEach((_1) => {
      ...
      cssClasses.forEach((_2) => {
        ...
        const props = document2.styles.get(cssClass) || /* @__PURE__ */ new Map();
        cssProps.forEach((cssProp) => {
          ...
          if (name && value) {
            props.set(name, new Property(document2, name, value));
          }
        });
        document2.styles.set(cssClass, props);
        document2.stylesSpecificity.set(cssClass, getSelectorSpecificity(cssClass));
  ...
  renderChildren(ctx) {
    ...
    if (element) {
      ...
      if (element.type === "symbol") {
        ...
        tempSvg.attributes.set("viewBox", new Property(document2, "viewBox", element.getAttribute("viewBox").getString()));
        tempSvg.attributes.set("preserveAspectRatio", new Property(document2, "preserveAspectRatio", element.getAttribute("preserveAspectRatio").getString()));
        tempSvg.attributes.set("overflow", new Property(document2, "overflow", element.getAttribute("overflow").getString()));
        tempSvg.children = element.children;
        element.styles.set("opacity", new Property(document2, "opacity", this.calculateOpacity()));
      }
      if (tempSvg.type === "svg") {
        const widthStyle = this.getStyle("width", false, true);
        const heightStyle = this.getStyle("height", false, true);
        if (widthStyle.hasValue()) {
          tempSvg.attributes.set("width", new Property(document2, "width", widthStyle.getString()));
        }
        if (heightStyle.hasValue()) {
          tempSvg.attributes.set("height", new Property(document2, "height", heightStyle.getString()));
        }
      }
...
svg-pathdata/lib/SVGPathData.module.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=dist-KWYEBBBZ.js.map
